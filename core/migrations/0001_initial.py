# Generated by Django 2.1.2 on 2018-11-12 21:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('escolaridade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Escolaridade', verbose_name='escolaridade do aluno')),
            ],
            bases=('core.pessoa',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('escolaridade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Escolaridade', verbose_name='escolaridade do professor')),
        ...
        migrations.AddField(
            model_name='pessoa',
            name='endereco',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Endereco', verbose_name='Endereço'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='endereco',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Endereco', verbose_name='endereco do curriculo'),
        ),
        migrations.AddField(
            model_name='curriculo',
            name='pessoa',
